        ...
        <div class="col-md-12">
            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    ?>
                        <!-- form start -->
                        <form class="editar_registrado" role="form" method="post" action="modelo-registrado.php" name="guardar-registro" id="guardar-registro">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="nombre">Nombre: </label>
                                    <input type="text" class="form-control" id="nombre" placeholder="Nombre" name="nombre" value ="<?php echo $registrado['nombre_registrado']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="apellido">Apellido: </label>
                                    <input type="text" class="form-control" id="apellido" placeholder="Apellido" name="apellido" value="<?php echo $registrado['apellido_registrado']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="email">Email: </label>
                                    <input type="email" class="form-control" id="email" placeholder="Email" name="email" value="<?php echo $registrado['email_registrado']; ?>">
                                </div>
                                <div class="form-group">
                                   <?php
                                            ...
                                            <li class="col-md-4">
                                                <div class="tabla-precio text-center">
                                                    ...
                                                    <div class="orden">
                                                        ...
                                                        <input type="number" class="form-control" min="0" id="pase_dia" size="3" placeholder="0" name="boletos[un_dia][cantidad]" value="<?php echo $boletos['un_dia']['cantidad']; ?>">
                                            ...
                                            <li class="col-md-4">
                                                <div class="tabla-precio text-center">
                                                    ...
                                                    <div class="orden">
                                                        ...
                                                        <input type="number" class="form-control" min="0" id="pase_completo" size="3" placeholder="0" name="boletos[completo][cantidad]" value="<?php echo $boletos['pase_completo']['cantidad']; ?>">
                                            ...
                                            <li class="col-md-4">
                                                <div class="tabla-precio text-center">
                                                    ...
                                                    <div class="orden">
                                                        ...
                                                        <input type="number" class="form-control" min="0" id="pase_2dia" size="3" placeholder="0" name="boletos[dos_dias][cantidad]" value="<?php echo $boletos['pase_2dias']['cantidad']; ?>">
                                                    ...
                                                    <div id="<?php echo str_replace('á','a',$dia);?>" class="contenido-dia clearfix row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <label class="col-md-12">
                                                                <input <?php echo (in_array($evento['id_evento'],$id_eventos_registrados['eventos']) ? 'checked' : ''); ?> type="checkbox" class="flat-red" name="registro_evento[]" id="<?php echo $evento['id_evento']; ?>" value="<?php echo $evento['id_evento']; ?>">
                                                ...
                                                <div class="caja clearfix row">
                                                    <div class="extras col-md-6">
                                                        <div class="orden">
                                                            ...
                                                            <input type="number" class="form-control" min="0" placeholder="0" id="camisa_evento" size="3" name="pedido_extra[camisas][cantidad]" value="<?php echo $boletos['camisas'] ?>">
                                                        ...
                                                        <div class="orden">
                                                            ...
                                                            <input type="number" class="form-control" min="0" placeholder="0" id="etiquetas_evento" size="3" name="pedido_extra[etiquetas][cantidad]" value="<?php echo $boletos['etiquetas'] ?>">
                                                        ...
                                                        <div class="orden">
                                                            ...
                                                            <select id="regalo" name="regalo" class="form-control seleccionar" required>
                                                                ...
                                                                <option value="2" <?php if($registrado['regalo'] == '2') echo 'selected';?> >Etiquetas</option>
                                                                <option value="1"<?php if($registrado['regalo'] == '1') echo 'selected';?> >Pulsera</option>
                                                                <option value="3" <?php if($registrado['regalo'] == '3') echo 'selected';?>>Pluma</option>
                                                            </select>
                                                        </div>
                                                        <!--orden-->
                                                        <br>
